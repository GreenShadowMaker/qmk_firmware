...
/*
*  mini board used for navigation in GuidWars2 connected to a second computer/laptop
*
*   Key Layout
*	 _____	 _____	 _____
*	|     | |     | |     |
...
*	|_____| |_____| |_____|
*
* Button 1 (tab) is Held to activate Layer 3 only while held
* 
*/
  	LAYOUT(
		LT(3, KC_TAB), KC_W, KC_1, KC_A, KC_SPC, KC_D),
