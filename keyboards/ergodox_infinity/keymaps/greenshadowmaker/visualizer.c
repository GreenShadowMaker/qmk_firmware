...
// gsm-copy from dudeofawesome keymap on June 2018 comments added as I compare to upper level visualizer
...
// gsm- colors changed compared to base visualizer
...
void initialize_user_visualizer(visualizer_state_t* state) {
   ...
   */
   // gsm- brightness changed compared to base visualizer
...
static uint8_t get_led_index_master(visualizer_user_data_t* user_data) {
  // gsm - total changed from 3 to 4 when compared to base visulizer.. for another layer?
  for (int i=0; i < 4; i++) {
...
// gsm - change from base, I don't understand
